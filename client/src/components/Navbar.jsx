...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <div className="md:hidden fixed bottom-0 inset-x-0 z-50 border-t border-white/10 bg-[#0a0a0a]/95 backdrop-blur-xl">
        <div className="grid grid-cols-3 px-2 py-2">
          <NavLink
            to="/dashboard"
            className={({ isActive }) => `flex flex-col items-center justify-center gap-1 rounded-xl py-2 text-[11px] font-medium transition-colors ${isActive ? 'text-white bg-white/10' : 'text-gray-400'}`}
          >
