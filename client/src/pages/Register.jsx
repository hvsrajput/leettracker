    ...
    <div className="min-h-[80vh] flex items-center justify-center p-6 animate-fade-in relative z-10 w-full overflow-hidden">
      ...
      <div className="w-full max-w-md animate-slide-up">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-extrabold text-white tracking-tight">Join LeetTracker</h1>
          <p className="text-gray-400 mt-3 text-sm font-medium">Start tracking your coding progress</p>
        </div>
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-1.5">
              <label htmlFor="username" className="block text-sm font-semibold text-gray-300 ml-1">Username</label>
              <input
                id="username"
                type="text"
                value={username}
          ...
          <p className="mt-8 text-center text-sm text-gray-400">
            ...
            <Link to="/login" className="font-semibold text-white hover:text-green-400 transition-colors">
              Sign in
            </Link>
          </p>
        </div>
